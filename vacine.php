<?php
  ...
  $json = file_get_contents('https://disease.sh/v3/covid-19/vaccine/coverage/countries/Hungary?lastdays=30&fullData=false');
...
<head>
  <meta charset="utf-8">
  <title>KoronaVírus elleni beoltottsági Statisztika</title>
      ...
      <div class="center mw7">
        ...
        <header class="header mw5 mw7-ns tl pa3">
          ...
          <p class="lh-copy measure black-60">
             Covid-19 Hazai statisztikák, hírek intézkedések.
          </p>   
           </div>
        <!-- FB SHARE HERE-->
        ...
        <div class="fl w-50 tc stat-card">
          <div class="card-box tilebox-one">
            ...
            <h6 class="black-40 ttu tl">Összes beoltott</h6>
